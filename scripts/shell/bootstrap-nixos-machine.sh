#!/usr/bin/env bash
# Bootstrap a NixOS machine: install Nix, clone nixcfg, and run the first
# system + home-manager switch. For non-NixOS Linux (Ubuntu, etc.) use
# bootstrap-linux-machine.sh instead; see docs/non-nixos-linux.md.
set -e
