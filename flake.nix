  ...
  outputs =
    ...
    in
    {
      ...
      homeConfigurations = {
        ...
        "tcarrio@obsidian" = libx.mkHome { hostname = "obsidian"; username = "tcarrio"; desktop = "hyprvibe"; };
      ...
      nixosConfigurations = {
        ...
        obsidian = libx.mkHost { systemType = "workstation"; hostname = "obsidian"; username = "tcarrio"; desktop = "hyprvibe"; determinate = true; };
