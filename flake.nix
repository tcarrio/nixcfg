  ...
  outputs =
    ...
    in
    {
      ...
      homeConfigurations = {
        ...
        "tcarrio@kuroi" = libx.mkHome { hostname = "kuroi"; username = "tcarrio"; desktop = "kde6"; };
      ...
      nixosConfigurations = {
        ...
        kuroi = libx.mkHost { systemType = "workstation"; hostname = "kuroi"; username = "tcarrio"; desktop = "kde6"; };
