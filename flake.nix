  ...
  outputs =
    ...
    in
    {
      ...
      homeConfigurations = {
        ...
        "tcarrio@glass" = libx.mkHome { hostname = "glass"; username = "tcarrio"; desktop = "cosmic"; };
      ...
      nixosConfigurations = {
        ...
        glass = libx.mkHost { systemType = "workstation"; hostname = "glass"; username = "tcarrio"; desktop = "cosmic"; };
