  ...
  outputs =
    ...
    in
    {
      ...
      homeConfigurations = {
        ...
        "tcarrio@obsidian" = libx.mkHome { hostname = "obsidian"; username = "tcarrio"; desktop = "hyprland"; };
      ...
      nixosConfigurations = {
        ...
        obsidian = libx.mkHost { systemType = "workstation"; hostname = "obsidian"; username = "tcarrio"; desktop = "hyprland"; };
