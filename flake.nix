  ...
  outputs =
    ...
    let
      ...
      mkSystemFlakeShell =
        ...
        shellOptionsFactory:
        pkgs.mkShell (
          (shellOptionsFactory { inherit pkgs darwinNixPkgs bun2NixPkg; })
          // {
    ...
    // {
      ...
      homeConfigurations = {
        # .iso images
        "nixos@iso-nuc" = libx.mkHome {
          hostname = "iso-nuc";
          username = "nixos";
        };

        # Workstations
        "tcarrio@gokin" = libx.mkHome {
          hostname = "gokin";
          username = "tcarrio";
        ...
        "tcarrio@void" = libx.mkHome {
          hostname = "void";
          username = "tcarrio";
          desktop = "cosmic";
        };
        "tcarrio@t510" = libx.mkHome {
          hostname = "t510";
          username = "tcarrio";
          desktop = "pantheon";
        };
        "tcarrio@vm" = libx.mkHome {
          hostname = "vm";
          username = "tcarrio";
          desktop = "gnome";
        };
        "tcarrio@chasm" = libx.mkHome {
          hostname = "chasm";
          username = "tcarrio";
          desktop = "i3";
        };
      ...
      nixosConfigurations = {
        ...
        iso-recovery-console = libx.mkHost {
          systemType = "iso";
          hostname = "iso-recovery";
          username = "nixos";
          installer = nixpkgs + "/nixos/modules/installer/cd-dvd/installation-cd-minimal.nix";
          determinate = false;
        };
        iso-recovery-desktop = libx.mkHost {
          systemType = "iso";
          hostname = "iso-recovery";
          username = "nixos";
          installer = nixpkgs + "/nixos/modules/installer/cd-dvd/installation-cd-minimal.nix";
        ...
        netboot-console = libx.mkHost {
          systemType = "iso";
          hostname = "netboot-iso-console";
          username = "nixos";
          installer = nixpkgs + "/nixos/modules/installer/netboot/netboot-minimal.nix";
          determinate = false;
        };
        ...
        t510-headless = libx.mkHost {
          systemType = "workstation";
          hostname = "t510-headless";
          username = "tcarrio";
        };
        chasm = libx.mkHost {
          systemType = "workstation";
      ...
      packages =
        ...
        libx.forAllSystems (
          ...
          (lib.optionalAttrs (system == "x86_64-linux") {
            ...
            digital-ocean-base-image = libx.mkGeneratorImage {
              systemType = "server";
              hostname = "generic-base-image";
              username = "archon";
              format = "do";
            };
