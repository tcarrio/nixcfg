  ...
  services.dnsmasq = {
    ...
    settings = {
      ...
      dhcp-host = [
        ...
        "00:04:4b:49:19:32,192.168.40.210" # TK1 00
        "00:04:4b:5a:f2:75,192.168.40.211" # TK1 01
        "00:04:4b:5a:ef:dc,192.168.40.212" # TK1 02
        #00:04:4b:xx:xx:xx,192.168.40.213  # TK1 03
        #00:04:4b:xx:xx:xx,192.168.40.213  # TK1 04
      ];
