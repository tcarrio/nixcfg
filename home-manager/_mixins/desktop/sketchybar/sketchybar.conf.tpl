...
{{bin.sketchybar}} --animate sin 30 --bar y_offset=-100 y_offset=9

### Template for some elements ###
{{bin.sketchybar}} --add item           label_template left                                \
...
{{bin.sketchybar}} --add       event          window_focus                                 \
...
{{bin.sketchybar}}   --add item        separator2 left                                     \
                     --set separator2  icon=┃                                              \
                                       icon.font="Hack Nerd Font:Regular:9.0"              \
...
{{bin.sketchybar}}   --add item        separator3 left                                     \
                     --set separator3  icon=┃                                              \
                                       icon.font="Hack Nerd Font:Regular:9.0"              \
...
### Battery Widget ###
{{bin.sketchybar}} --add item battery right                                          \
...
### Updates Widget ###
{{bin.sketchybar}} --add item updates right                                        \
...
### Uptime Widget ###
{{bin.sketchybar}} --add item uptime right                                         \
                   --set uptime update_freq=120                                    \
                       ...
                       icon.padding_left=0 label.padding_right=2                   \
### ssd Widget ###
{{bin.sketchybar}} --add item  ssd right                                           \
...
### mem Widget ###
{{bin.sketchybar}} --add item  mem right                                           \
...
### cpu Widget ###
{{bin.sketchybar}} --add item  cpu right                                           \
...
### os version Widget ###
{{bin.sketchybar}} --add item  ver right                                           \
